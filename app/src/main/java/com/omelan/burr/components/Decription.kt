        ...
        Card(modifier = modifier) {
            Column(
                ...
                Text(
                    ...
                    modifier = Modifier.padding(start = 15.dp, end = 15.dp, top = 15.dp).animateContentSize()
                )
                Icon(
...
fun DescriptionPreview() {
    Description(descriptionText = "Recipe made by Hoffman Weird Coffee Person. Grind mildly \n https://www.youtube.com/watch?v=AI4ynXzkSQo ")
}
